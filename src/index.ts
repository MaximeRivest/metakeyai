...
async function initializeApp() {
  ...
  try {
    ...
    if (!setupStatus.isConfigured) {
      console.log('⚠️ Python not properly configured - initializing with limited functionality');
      
      // Initialize spell caster in fallback mode
    ...
    try {
      spellCaster = pythonSpellCaster;
      await spellCaster.initializeFallback();
      console.log('⚠️ Spell Caster initialized in fallback mode');
    } catch (fallbackError) {
